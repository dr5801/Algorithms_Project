...
int main(void)
{
	...
	file_names[0] = "../text_files/small_list/unsorted/random_";
	file_names[1] = "../text_files/medium_list/unsorted/random_";
    file_names[2] = "../text_files/large_list/unsorted/random_";
...
void generate_rand_numbers(FILE *file, int amount_to_generate)
{
	...
	for(i = 0; i < amount_to_generate; i++)
	{
        ...
        unsigned int random_value = (int) (((double)(diff+1)/RAND_MAX) * rand() + MIN_VALUE);
